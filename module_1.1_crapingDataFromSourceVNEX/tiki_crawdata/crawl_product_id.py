...
headers = {
    ...
    'Referer': 'https://tiki.vn/xe-tay-ga/c11878?brand=153444',
    'x-guest-token': '0jPTYOM6GxpUEFvBZ2hkelJzg4QrowL5',
...
params = {
    ...
    'trackity_id': '607572fe-4fb3-00bf-9297-9ca0fbfd1040',
    'aggregations': '2',
    'category': '11878',
    'page': '',
    'urlKey': 'xe-tay-ga',
...
df.to_csv('product_id_yamaha.csv', index=False)
